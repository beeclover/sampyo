...
<div class="container xl:max-w-screen-xl mx-auto">
  ...
  <p>
    환경 ∙ 사람 ∙ 사회를 배려하고, 더 나은 미래를 만들기 위한 사회적 임팩트를 중시합니다. 사회와 환경에 긍정적인 영향을 미치는 공유 가치를 만들어감으로써 이해 관계자들에게 긍정적인 경험을 제공하고자 합니다.
  </p>
  <div class="pb-[70px] sm:pb-24"></div>
  <div class="coverbox-full left py-[50px] sm:py-28">
    <div class="page__level-title mb-4">
      사회 공헌활동의 지향점
    </div>
    <p>
      사회공헌 활동은 사회적 임팩트(Social Impact)을 만들기 위한 기초입니다. 지속 가능한 미래를 만들기 위해 환경 ∙ 사람 ∙ 사회에 대한 책임감으로 지역 사회, 파트너 및 구성원과의 신뢰 구축을 최우선 활동으로 추진합니다. 건설 소재 사업에서 연유하는 환경에 대한 부정적 영향을 최소화하기 위해 노력합니다.
    </p>
    <div class="pb-[70px] sm:pb-24"></div>
    <div class="relative">
      ...
      <div id="csrSwiper" class="z-10 sm:z-0 sm:invisible overflow-hidden">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 mb-[20px] sm:mb-14 gap-y-4 gap-x-12">
    ...
    <div class="prose">
      <p>
        고 정인욱 명예회장은 사재를 출연하여 기업의 이윤을 사회로 환원하며, 기업의 사회적 책임을 수행했습니다. 사회 전체의 이익을 증진시키고 국민 생활 향상을 도모하면서 사회에 필요한 인재를 발굴하고 육성하고자 했습니다. 이러한 취지에 따라, 고 정인욱 명예회장의 차남 정도원 삼표그룹 회장이 부친의 유지를 이어받아 2002년부터 매년 10억원을 재단에 출연하고 있으며, 현재 건실한 재단으로 성장하였습니다.  
      </p>
    </div>
  </div>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-4 mb-[20px] sm:mb-16">
    <div>
      @include('partials.img', ['ex' => 'jpg', 'name' => 'sampyo-group-csr-5'])
    </div>
    <div class="prose">
      <p>
        삼표는 지역 사회와 함께합니다. 삼표의 제품과 기술로 만들어진 건축 재료인 초고성능 콘크리트(UHPC)를 활용한 업사이클링 벤치입니다. 시민들의 일상에 편안한 휴식을 드리고자 하는 마음을 담았습니다. 삼표만의 재료와 기술을 담은 의자를 거리 곳곳에서 편하게 만나볼 수 있습니다. 
      </p>
    </div>
    <div>
    ...
    <div class="prose">
      <p>
        삼표는 지역 사회의 추운 겨울에도 손길을 내밉니다. 삼표그룹의 모태인 강원산업의 대표 제품이었던 연탄을 지역 사회의 에너지 취약 계층 가구에 전달하고 있습니다. 또한, 생필품인 쌀 등을 임직원이 직접 방문해 전달하는 참여형 봉사 활동을 실시합니다.
      </p>
    </div>
  </div>
  <div class="pb-[30px] sm:pb-20"></div>
  <div class="font-black underline power text-2xl mb-6">환경 보호</div>
  <div class="grid grid-cols-1 gap-y-[20px] sm:gap-y-12">
    <div>
