...
<div class="container xl:max-w-screen-xl mx-auto">
    ...
    <div>
      <div class="prose">
        <p>
          ...
          또한 선진물류 인프라를 구축하고 믹서트럭 운영 최적화를 위한 지원시스템을 강화하는 등 고객 요구에 부응하고 있습니다. 더불어 자체 품질관리 기준인 <a href="#SKS">SKS(Sampyo KS)</a>를 개발 운영하여 최고의 품질을 유지하고 있습니다.
        </p>
      </div>
    </div>
    <div>
    ...
    <div>
      <div class="flex flex-col justify-between h-full">
        <div class="prose mb-[30px] sm:mb-16">
          ...
          <p>
            <span class="pointUnderLine" style="--bs: var(--RGB-atmosphere)">이러한 환경에 대응할 수 있는 것이 삼표의 특수 레미콘 브랜드 블루콘입니다</span>
          </p>
          <p>
            블루콘은 일반 콘크리트가 지닌 재료적 한계성을 다양한 건설환경에 따라 개선시킨 프리미엄 레미콘 브랜드입니다. 지속적으로 고객요구를 반영하여 그 성능을 향상시키고 있습니다. 블루콘은 일반 콘크리트 특성(강도, 작업성, 내구성)보다 특별한 성능을 제공하여 현장의 환경 조건에 대응하고, 고객의 어려움을 해결해 줄 수 있으며, 고객이 사용시 체감할 수 있는 특수한 성능을 제공하여 고객의 요구를 만족시킵니다. 블루콘은 사용 목적에 따라 5종의 제품으로 공급됩니다.
          </p>
        </div>
        <div>
  ...
  <div class="prose">
    <p>
      삼표는 첨단의 디지털 기술을 물류시스템에 활용합니다. 실시간 교통상황을 반영하여 최적 운행경로를 자동 안내하는 기능 (잔여 시간 및 거리확인), 동일 현장행 차량 정보와 납품 진행현황을 확인하는 기능, 현장의 주요 정보를 실시간으로 음성 안내하는 기능 등을 제공하며 대형차량이 안전하게 운행할 수 있도록 최적의 주행경로를 제공합니다.
    </p>
  </div>
