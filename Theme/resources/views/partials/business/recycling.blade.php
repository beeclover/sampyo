...
<div class="container xl:max-w-screen-xl mx-auto">
  ...
  <section class="mb-[70px] sm:mb-32">
    <div class="coverbox-full-fixedHeight left max:sm:py-[30px] sm:pt-24" style="--h: 460px">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-[30px] sm:gap-y-[70px]">
        ...
        <div class="coverbox-label sm:col-span-2">
          @include('partials.img', ['ex' => 'jpg', 'name' => 'business-recycling-4'])
          <span class="label text-white">
            철스크랩 재활용
          </span>
        </div>
  ...
  <section class="mb-[70px] sm:mb-32">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-[30px] sm:gap-y-12">
      ...
      <div>
        <div class="coverbox-label">
          @include('partials.img', ['ex' => 'jpg', 'name' => 'business-recycling-6'])
          <span class="label text-white">
            제강슬래그 재활용
          </span>
        </div>
      ...
      <div>
        <div class="coverbox-label">
          @include('partials.img', ['ex' => 'jpg', 'name' => 'business-recycling-7'])
          <span class="label text-white">
            제강슬래그 재활용
          </span>
        </div>
      </div>
      <div class="prose sm:col-span-2">
        <p>
          당사는 제강사 및 스크랩처리업체에서 발생되는 스크랩더스트를 수집/선별/가공하여 유가물을 제강사 및 비철 제조사의 원료로 공급하고 있습니다.<br/>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-[30px] sm:gap-y-12 mb-[30px] sm:mb-[70px]">
      ...
      <div>
        <div class="prose">
          ...
          <p>
            당사는 생활 및 산업현장에서 발생되는 폐기물을 보다 안전하게 소각하기 위하여 최신설비를 도입했으며, 철저한 사후관리를 통해 환경오염을 방지하고 있습니다. 
          </p>
          <p>
  ...
  <section class="mb-[70px] sm:mb-32">
    <div class="coverbox-full-fixedHeight right max:sm:py-[30px] sm:pt-24" style="--h: 750px">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-[30px] sm:gap-y-[70px] mb-[30px] sm:mb-[80px]">
        ...
        <div class="prose">
          <p>
            하역사업부는 포항신항 8부두에 3만톤급 2선석, 1만톤급 1선석 운영을통해 연간 200만톤 이상의 하역 처리 능력으로 포항 철강공단 수출입 화물의 원활한 처리를 담당하고 있으며, 평택·당진항만에 3만톤급 1선석 운영을 통해, 연간 130만톤의 규모의 하역 처리 능력을 보유하고 있습니다. 
          </p>
        </div>
      </div>
      <div class="mb-[50px]">
        ...
        <div class="prose">
          <p>
            철스크랩, STS 스크랩, Pig Iron, 부원료(Sli-Mn, Fe-Si 등), 반제품(Billet 등), 철제품(H빔, Sheet Pile, 철근, Angle, Rail 등)
          </p>
        </div>
      </div>
      <div class="coverbox-label">
