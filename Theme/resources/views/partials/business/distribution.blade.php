...
<div class="container xl:max-w-screen-xl mx-auto">
  <section class="mb-[70px] sm:mb-32">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-[50px] gap-y-[70px]">
      ...
      <div class="prose">
        또한 기업 경쟁력의 핵심인 물류, 운송 구조를 효율적으로 개선함으로써 기업의 물류비용을 줄이고 물류 생산성을 향상시켜 기업의 이익 증대를 최우선 목표로 하고 있습니다. 앞으로도 오랜 기간 축적해온 노하우를 바탕으로 고객의 다양한 니즈 충족과 효율적인 물류 운영으로 대한민국 건설복합물류 대표기업으로 자리매김하겠습니다.
      </div>
      <div>
        <div class="coverbox-label">
          @include('partials.img', ['ex' => 'jpg', 'name' => 'business-distribution-0'])
          <span class="label text-white">최적화된 물류인프라</span>
        </div>
      </div>
      <div>
        <div class="coverbox-label">
          @include('partials.img', ['ex' => 'jpg', 'name' => 'business-distribution-1'])
          <span class="label text-white">선진화된 물류시스템</span>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-[50px] max:sm:mb-[30px]">
        <div>
          ...
          <div class="mb-7">
            ...
            <div class="prose">
              <p>
                전국적으로 육송거점 26개소, 해송거점 13개소, 철송거점 3개소를 운영하여 전국적인 물류 네트워크를 구축하고 있습니다.
              </p>
            </div>
          </div>
          <div>
  ...
  <section>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-[50px] gap-y-[30px] sm:gap-y-[60px] mb-[30px] sm:mb-[70px]">
      ...
      <div class="prose">
        <p>
          또한 전통적인 물류시장 구조에서 발전하여 GPS, Mobile, RFID를 활용해 IT와 접목한 선진화된 물류 시스템을 운영하고 있습니다. 전국 각 거점에 출하자동화 시스템을 구축하고, 통합관리시스템을 운영함으로써 제품 입/출고의 자동화를 꾀하고, 물류 시장의 주체들을 하나의 네트워크로 연결하는 물류 플랫폼을 개발하여 4차산업 시대의 첨단 물류 선도기업으로 발돋움하고 있습니다.
        </p>
      </div>
      <div class="sm:col-span-2">
        @include('partials.img', ['ex' => 'jpg', 'name' => 'business-distribution-11'])
      </div>
      @foreach ([
        [
          'title' => <<<EOD
...
EOD,
          'content' => <<<EOD
          삼표는 차량 배차부터 입출고, 납품서 발행, 제품 상ㆍ하차에 이르는 출하 전 과정을 무인 자동화로 운영하는 첨단 시스템을 업계 최초로 갖추고 있습니다.<br/>
          자동출하시스템 도입으로 출하 시간이 약 20% 단축되었으며 고객이 원하는 시간에 맞춰 보다 신속하게 제품을 공급할 수 있습니다.
EOD
        ],
        [
          'title' => <<<EOD
