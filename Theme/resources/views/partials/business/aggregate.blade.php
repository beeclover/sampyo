...
<div class="container xl:max-w-screen-xl mx-auto">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 sm:gap-x-12 gap-y-[30px] sm:gap-y-20">
    ...
    <div class="max:sm:order-3">
      <div class="coverbox-label">
        ...
        <span class="label text-white">국내 최초 석산 KS인증(전 석산 KS인증)</span>
      </div>
    </div>
  </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-[30px] sm:gap-y-20">
      ...
      <div class="max:sm:order-2">
        <div class="coverbox-label">
          ...
          <span class="label text-white">석산 양질의 원석 채취</span>
        </div>
      </div>
      <div class="max:sm:order-4">
        <div class="coverbox-label">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-[30px]">
    <div>
      <p>
        1970년대 이후 대한민국 경제발전에 따른 수도권 도시개발은 건설기초소재인 골재의 적절한 공급이 있었기에 가능했습니다.<br/>
    ...
    <div class="max:sm:order-first">
      @include('partials.img', ['ex' => 'jpg', 'name' => '156', 'class' => 'sm:transform sm:-translate-x-10'])
    </div>
  </div>
</div>
</main>